...
export default function SetUsername({ user, onDone }) {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#FAF9F6', padding: 24 }}>
      <div style={{ maxWidth: 400, width: '100%', background: '#fff', borderRadius: 16, padding: 32, border: '1px solid #E5E3DC' }}>
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          ...
          <p style={{ color: '#5F5E5A', fontSize: 14 }}>Choose a username for your BizCheck account. This is what others will see.</p>
        </div>
        ...
        <div className="form-group">
          ...
          <div style={{ position: 'relative' }}>
            ...
            />
            <span style={{ position: 'absolute', left: 10, top: '50%', transform: 'translateY(-50%)', color: '#888780', fontSize: 15 }}>@</span>
            {checking && <span style={{ position: 'absolute', right: 10, top: '50%', transform: 'translateY(-50%)', fontSize: 12, color: '#888780' }}>checking…</span>}
